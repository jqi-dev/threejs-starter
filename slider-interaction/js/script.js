...
var renderer;
var mesh;
var cubeX, cubeY, cubeZ // Used with the sliders
...
function init() {
  ...
  var geometry = new THREE.BoxGeometry(2, 2, 2); // Define the geometry
...
function animate() {
  ...
  // Grab the value from the sliders
  cubeX = document.getElementById("cubeX").value;
  cubeY = document.getElementById("cubeY").value;
  cubeZ = document.getElementById("cubeZ").value;
  
  // Use the slider value to update the cube object
  mesh.scale.set(cubeX, cubeY, cubeZ);
